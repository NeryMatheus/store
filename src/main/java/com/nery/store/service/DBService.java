...
public class DBService {
    ...
    public void instanciaBasedeDados(){
        ...
        Produto p1 = new Produto(null, "TV 42 Polegadas", "TV 42 Polegadas", cat1);
        Produto p2 = new Produto(null, "Mouse", "Mouse Logitech", cat1);
        Produto p3 = new Produto(null, "Teclado", "Teclado Logitech", cat1);
        Produto p4 = new Produto(null, "Filtro de água", "Filtro de água", cat2);
        Produto p5 = new Produto(null, "Cloro", "Cloro", cat2);
        Produto p6 = new Produto(null, "Guitarra", "Guitarra", cat3);
        Produto p7 = new Produto(null, "Violão", "Violão", cat3);
